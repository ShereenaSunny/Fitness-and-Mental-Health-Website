...
<div class="left col-md-11">
	...
	<thead class="thead-pink">
		<tr>
			<th scope="col" onclick="sortTable(0)">Title <i class="fas fa-sort"></i></th>
...
<div class="right col-md-1">
	...
	<!-- logout button -->
	<a class="logoutBtn" href="/serene/index.html">Go Back to Home</a>
</div>
